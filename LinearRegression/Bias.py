...
for _ in range(40):  # Iterate through the training process 10 times to adjust weights.
    '''
...
Result
Cost: 16.67
Cost remains high and Predictions are way off
Increasing the epochs won't help either
After a few epochs, weight and cost doesn't change anymore

Conclusion
We need something to move the regression line up and down to change the y intercept
