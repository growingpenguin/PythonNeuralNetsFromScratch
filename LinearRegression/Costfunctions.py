...
# mse = sum((prediction - target)**2) / len(points)
# By squaring the error, result is always positive
...
for _ in range(25):  # Iterate through the training process 25 times to adjust weights.
    ...
    errors = [(p - t) ** 2 for p, t in zip(pred, targets)] # Overflow Error, the cost is too big to change the weight
